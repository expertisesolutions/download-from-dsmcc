...
struct carousel
{
                       ...
                       , unsigned int module_id)
  {
    ...
    dfd::object_key k = {object_key_, module_id};
  ...
  {
    dfd::object_key k = {object_key, module_id};
    std::map<dfd::object_key, file_object>::iterator iterator
      = file_objects.find(k);
  ...
  {
    dfd::object_key k = {object_key, module_id};
    std::map<dfd::object_key, directory_object>::iterator iterator
  ...
  std::map<dfd::object_key, file_object> file_objects;
  std::map<dfd::object_key, directory_object> directory_objects;
