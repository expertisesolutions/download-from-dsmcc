                       ...
                       , dfd::programs& programs, __u16 pmt_pid, __u16 dsmcc_pid)
{
  ...
  {
    typedef gts::dsmcc::download_info_indication<typename user_network_type::base_iterator>
  ...
  {
    typedef gts::dsmcc::download_server_initiate<typename user_network_type::base_iterator>
