               ...
               , dfd::programs& programs, __u16 pmt_pid, __u16 dsmcc_pid)
{
  ...
  // if(*transaction_id <= 1 || false)
  {
    ...
    {
      dfd::download_scenario ds (*download_id);
      ...
      typedef typename boost::range_value<module_range_type>::type module_type;
      for(typename boost::range_iterator<module_range_type>::type
            ...
            ;first != last; ++first)
      {
        ...
        dfd::module module(*id, *version, *size, *block_size);
